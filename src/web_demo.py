#!/usr/bin/env python3
"""
SymbolicLight-PoC — Inference Web Demo
======================================
Interactive Gradio interface for the historical PoC checkpoint.

Usage:
  python web_demo.py
  python web_demo.py --checkpoint ./src/best.pt
"""
import sys
import time
import argparse
...
def load_model(checkpoint_path: str):
    ...
    print(f"[Load] Model loaded | {n_params/1e6:.1f}M params")
